...
/**
 * Created by zhaihuilin on 2019/2/27 17:49.
 */
public class FileUploadTool {
  ...
  public VideoDomain createFile(String logoPathDir, MultipartFile multipartFile, HttpServletRequest request) {
    VideoDomain entity = new VideoDomain();
    boolean bflag = false;
...
// 文件类型判断
    ...
    if (bflag) {
      String logoRealPathDir = "D:/video/";
...
// 源文件保存路径
      ...
      if (aviPath != null) {
        ...
        entity.setVideoName(newFileName);
